...
boards_dataset = dataset_base.copy({
    'name': 'Immersive Limit - boards',
    'train_info': './data/custom_dataset/annotations.json',
    'train_images': './data/custom_dataset/JPEGImages/',
    'valid_info': './data/custom_dataset/annotations.json',
    'valid_images': './data/custom_dataset/JPEGImages/',
    'class_names': ('cl', 'ds'),
    'label_map': {1: 1, 2: 2}
})
...
yolact_resnet50_boards_config = yolact_resnet50_config.copy({
    'name': 'yolact_resnet50_boards',
    # Dataset stuff
    'dataset': boards_dataset,
    'num_classes': len(boards_dataset.class_names) + 1,
